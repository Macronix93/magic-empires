...
$result = check_user_login_and_kingdom($user, BuildingTypes::BUILDING_MILL);
...
$boost_value = (int)($ft_res["foodrate"] * BASE_FOOD_GAIN);
...
$view .= "<div style='margin: auto; width: 350px;'>
                <div class='split-content'><b>Nahrungsertrag pro Stunde:</b> " . fnum($kingdom->get_base_food_rate()) . " $boost_display</div>
                $next_level_text
            </div>
";
