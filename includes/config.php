...
// --- Marketplace ---
const MARKET_DAILY_TRADES_BASE = 3;
const MARKET_TRADES_PER_UPGRADE = 0.2;
const MARKET_UPGRADE_LIMIT = 7;
const MARKET_BASE_FEE = 8;
const MARKET_OFFER_DURATION = 86400;                // 24 hours
const MARKET_CAPACITY_PER_LEVEL = 50000;
const MARKET_FEE_MULTIPLIER_FOOD = 0.000075;
const MARKET_FEE_MULTIPLIER_WOOD = 0.000075;
const MARKET_FEE_MULTIPLIER_STONE = 0.0001;
const MARKET_FEE_MULTIPLIER_GOLD = 0.00025;
...
const KINGDOM_OVERFLOW_FACTOR = 0.75;
...
const SMITHY_INF_ATK_BONUS = 6;
const SMITHY_INF_DEF_BONUS = 8;
const SMITHY_CAV_ATK_BONUS = 9;
const SMITHY_CAV_DEF_BONUS = 9;
const SMITHY_ARC_ATK_BONUS = 8;
const SMITHY_ARC_DEF_BONUS = 6;
...
const WORLD_EVENT_DMG_ATTACK_DURATION = 30;
...
const WORLD_EVENT_REWARD_TRESHOLD_3 = 500000;
...
const WORLD_EVENT_REWARD_COINS_3 = 4;
const WORLD_EVENT_REWARD_COINS_4 = 4;
const WORLD_EVENT_REWARD_COINS_5 = 3;
const WORLD_EVENT_REWARD_COINS_6 = 2;
const WORLD_EVENT_DAMAGE_TIERS = [
    WORLD_EVENT_REWARD_MIN_TRESHOLD => ["coins" => WORLD_EVENT_REWARD_COINS_MIN, "gold" => 5000],
    WORLD_EVENT_REWARD_TRESHOLD_1 => ["coins" => WORLD_EVENT_REWARD_COINS_1, "gold" => 5500],
    WORLD_EVENT_REWARD_TRESHOLD_2 => ["coins" => WORLD_EVENT_REWARD_COINS_2, "gold" => 6000],
    WORLD_EVENT_REWARD_TRESHOLD_3 => ["coins" => WORLD_EVENT_REWARD_COINS_3, "gold" => 6500],
    WORLD_EVENT_REWARD_TRESHOLD_4 => ["coins" => WORLD_EVENT_REWARD_COINS_4, "gold" => 7000],
    WORLD_EVENT_REWARD_TRESHOLD_5 => ["coins" => WORLD_EVENT_REWARD_COINS_5, "gold" => 7500],
    WORLD_EVENT_REWARD_TRESHOLD_6 => ["coins" => WORLD_EVENT_REWARD_COINS_6, "gold" => 8000]
];
// HP-Boss Resources
...
const GUILD_SUPPORT_TRAVEL_BOOST = 0.2;
...
const GUILD_SETTINGS_CHANGE_COOLDOWN_DAYS = 2;
const GUILD_STORAGE_BASE_COAL = 1000;
const GUILD_STORAGE_BASE_IRON = 700;
const GUILD_STORAGE_BASE_SAPPHIRE = 400;
const GUILD_STORAGE_BASE_DIAMOND = 200;
const GUILD_STORAGE_INC_FACTOR = 1.8;
const GUILD_BONUS_EVENT_GOLD_PER_LVL = 0.05;
const GUILD_BONUS_ALLY_TRADE_SPEED_PER_LVL = 0.04;
const GUILD_BONUS_SUPPORT_CAP_PER_LVL = 25;
const GUILD_BONUS_SUPPORT_SPEED_PER_LVL = 0.03;
const GUILD_BONUS_MEMBER_LIMIT_PER_LVL = 2;

// --- Abandoned Kingdoms ---
const ABANDONED_MIN_TC_LEVEL = 3;
const ABANDONED_MIN_STORAGE_LEVEL = 3;
const ABANDONED_RESOURCE_SHARE = 0.5;
const ABANDONED_HOURLY_PRODUCTION_BONUS = 2;
const ABANDONED_SOLDIER_TO_MONSTER_RATIO = 10;    // 10 soldiers = 1 monster
const ABANDONED_MIN_MONSTER_BASE = 10;

// --- Overview Pagination ---
const OVERVIEW_PAGESIZE_MIN = 5;
...
{
    const int GUILD_TECH_TYPE_STORAGE = 0;
    const int GUILD_TECH_EVENT_GOLD = 1;
    const int GUILD_TECH_ALLY_TRADE_SPEED = 2;
    const int GUILD_TECH_SUPPORT_CAPACITY = 3;
    const int GUILD_TECH_SUPPORT_SPEED = 4;
    const int GUILD_TECH_MEMBER_LIMIT = 5;
}
...
interface ResourceTypes
{
    ...
    const int RESOURCE_TYPE_COAL = 11;
    const int RESOURCE_TYPE_IRON = 12;
    const int RESOURCE_TYPE_SAPPHIRE = 13;
    const int RESOURCE_TYPE_DIAMOND = 14;
}
