...
const MONSTER_CAMP_WEIGHT_LOW = 0.4; // Level 1-3
const MONSTER_CAMP_WEIGHT_MID = 0.3; // Level 4-6
const MONSTER_CAMP_WEIGHT_HIGH = 0.2; // Level 7-9
const MONSTER_CAMP_WEIGHT_BOSS = 0.1; // Level 10
