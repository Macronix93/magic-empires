<div style="text-align: left; max-width: 100%;">
    ...
    <p>magic-empires.de - Sylvan Giese<br/>
        ...
        Europaring 90<br/>
        53757 St Augustin</p>
    <p>E-Mail: webmaster@magic-empires.de</p>
    ...
    <p>Google
        agiert in diesem Zusammenhang als reiner Auftragsdatenverarbeiter im Sinne von Art. 28 DSGVO und wird die auf
        diesem Wege erhobenen Daten nicht f&uuml;r eigene Zwecke nutzen. Die Nutzung des Tools erfolgt auf Grundlage
        eines Auftragsverarbeitungsvertrags (DPA) mit Google.</p>
    <p>Die Speicherung und Analyse der Daten erfolgt auf
        Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse daran, seine
        Webangebote vor missbr&auml;uchlicher automatisierter Aussp&auml;hung und vor SPAM zu sch&uuml;tzen.
        ...
        Cookies oder den Zugriff auf Informationen im Endger&auml;t des Nutzers (z.&nbsp;B. Device-Fingerprinting) im
        Sinne des TDDDG umfasst. Die Einwilligung ist jederzeit widerrufbar.</p>
